...
encmedia = await arielspkece.sendImageAsSticker(m.chat, wifegerakx, ftroli, { packname: global.packname, author: global.author, })
await fs.unlinkSync(encmedia)
}
break
case 'terjemahan': {
...
var wifegerak = ano.split('\n')
var wifegerakx = wifegerak[Math.floor(Math.random() * wifegerak.length)]
encmedia = await arielspkece.sendImageAsSticker(m.chat, wifegerakx, ftok, { packname: global.packname, author: global.author, })
await fs.unlinkSync(encmedia)
}
break
case 'doge':
