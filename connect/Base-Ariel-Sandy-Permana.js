...
let arielTiktod = await yts(text)
let ggAbis = arielTiktod.videos[Math.floor(Math.random() * arielTiktod.videos.length)];
...
let arielTiktod18 = await yts(text)
let ggAbis18 = arielTiktod18.videos[Math.floor(Math.random() * arielTiktod18.videos.length)];
let arielTiktod19 = await yts(text)
let ggAbis19 = arielTiktod19.videos[Math.floor(Math.random() * arielTiktod19.videos.length)];
let arielTiktod20 = await yts(text)
let ggAbis20 = arielTiktod20.videos[Math.floor(Math.random() * arielTiktod20.videos.length)];
let arielTiktod21 = await yts(text)
let ggAbis21 = arielTiktod21.videos[Math.floor(Math.random() * arielTiktod21.videos.length)];
const arielkecesp = `Hii Kak *${m.pushName}* ${ucapanWaktu}

Silahkan Klick Button Dibawah Untuk Melihat Yang Anda Cari Di Fitur YouTube Play`
let sections = [
{
title: `1. ${ggAbis.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
{
title: `2. ${ggAbis2.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis2.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis2.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
{
title: `3. ${ggAbis3.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis3.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis3.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
{
title: `4. ${ggAbis4.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis4.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis4.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
{
title: `5. ${ggAbis5.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis5.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis5.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
{
title: `6. ${ggAbis6.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis6.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis6.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
{
title: `7. ${ggAbis7.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis7.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis7.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
{
title: `8. ${ggAbis8.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis8.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis8.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
{
title: `9. ${ggAbis9.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis9.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis9.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
{
title: `10. ${ggAbis10.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis10.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis10.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
{
title: `11. ${ggAbis11.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis11.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis11.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
{
title: `12. ${ggAbis12.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis12.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis12.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
{
title: `13. ${ggAbis13.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis13.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis13.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
{
title: `14. ${ggAbis14.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis14.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis14.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
{
title: `15. ${ggAbis15.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis15.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis15.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
{
title: `16. ${ggAbis16.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis16.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis16.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
{
title: `17. ${ggAbis17.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis17.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis17.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
{
title: `18. ${ggAbis18.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis15.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis15.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
...
{
title: `19. ${ggAbis19.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis19.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis19.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
{
title: `20. ${ggAbis20.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis20.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis20.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
{
title: `21. ${ggAbis21.title}`,
rows: [
{title: `🎧 MP3`, rowId: `#ytmp3 ${ggAbis21.url}`, description: `YT : ArielSP Sus Please Subscribe`},
{title: `🎥 MP4`, rowId: `#ytmp4 ${ggAbis21.url}`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
]
let listMessage = {
...
text: arielkecesp, 
buttonText: `Click Here This Result`,
sections}
arielspkece.sendMessage(m.chat, listMessage, {quoted :m })
}
break
...
rows: [
{title: "🇮🇩 Semua Menu", rowId: `#menu3`, description: `YT : ArielSP Sus Please Subscribe`},
{title: "🇮🇩 Group Menu", rowId: `#groupa`, description: `YT : ArielSP Sus Please Subscribe`},
{title: "🇮🇩 Owner Menu", rowId: `#ownera`, description: `YT : ArielSP Sus Please Subscribe`},
{title: "🇮🇩 Fun Menu", rowId: `#funa`, description: `YT : ArielSP Sus Please Subscribe`},
{title: "🇮🇩 Convert Menu", rowId: `#cona`, description: `YT : ArielSP Sus Please Subscribe`},
{title: "🇮🇩 Nulis Menu", rowId: `#nulisa`, description: `YT : ArielSP Sus Please Subscribe`},
{title: "🇮🇩 Textpro Menu", rowId: `#texta`, description: `YT : ArielSP Sus Please Subscribe`},
{title: "🇮🇩 Anime Menu", rowId: `#animea`, description: `YT : ArielSP Sus Please Subscribe`},
{title: "🇮🇩 Kisah Nabi Menu", rowId: `#kisaha`, description: `YT : ArielSP Sus Please Subscribe`},
{title: "🇮🇩 Download Menu", rowId: `#downloada`, description: `YT : ArielSP Sus Please Subscribe`},
{title: "🇮🇩 Wa Imun Menu", rowId: `#waa`, description: `YT : ArielSP Sus Please Subscribe`},
{title: "🇮🇩 Sound Menu", rowId: `#sounda`, description: `YT : ArielSP Sus Please Subscribe`},
]
},
]
let listMessage = {
