...
//SALAM
const fariel = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title": `${wib} *𝑾𝒊𝒃*\n       ${wita} *𝑾𝒊𝒕𝒂*\n       ${wit} *𝑾𝒊𝒕*`,"h": `${wib} *𝑾𝒊𝒃*\n       ${wita} *𝑾𝒊𝒕𝒂*\n       ${wit} *𝑾𝒊𝒕*`,'duration': '99999', 'gifPlayback': 'true', 'caption': `${wib} *𝑾𝒊𝒃*\n       ${wita} *𝑾𝒊𝒕𝒂*\n       ${wit} *𝑾𝒊𝒕*`,'jpegThumbnail': fs.readFileSync('./connect/image/logo.jpg')}}}
...
arielspkece.sendImageAsSticker(m.chat, loli, fariel, { packname: global.botname, author: global.packname })
}
//Toxic
const farielsp = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title": `${wib} *𝑾𝒊𝒃*\n       ${wita} *𝑾𝒊𝒕𝒂*\n       ${wit} *𝑾𝒊𝒕*`,"h": `${wib} *𝑾𝒊𝒃*\n       ${wita} *𝑾𝒊𝒕𝒂*\n       ${wit} *𝑾𝒊𝒕*`,'duration': '99999', 'gifPlayback': 'true', 'caption': `${wib} *𝑾𝒊𝒃*\n       ${wita} *𝑾𝒊𝒕𝒂*\n       ${wit} *𝑾𝒊𝒕*`,'jpegThumbnail': fs.readFileSync('./connect/image/logo.jpg')}}}
...
arielspkece.sendImageAsSticker(m.chat, galak, farielsp, { packname: global.botname, author: global.packname })
}
//Panggil
const farielsp2 = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title": `${wib} *𝑾𝒊𝒃*\n       ${wita} *𝑾𝒊𝒕𝒂*\n       ${wit} *𝑾𝒊𝒕*`,"h": `${wib} *𝑾𝒊𝒃*\n       ${wita} *𝑾𝒊𝒕𝒂*\n       ${wit} *𝑾𝒊𝒕*`,'duration': '99999', 'gifPlayback': 'true', 'caption': `${wib} *𝑾𝒊𝒃*\n       ${wita} *𝑾𝒊𝒕𝒂*\n       ${wit} *𝑾𝒊𝒕*`,'jpegThumbnail': fs.readFileSync('./connect/image/logo.jpg')}}}
let manggil = './connect/image/logo.jpg'
if (body.includes(`kontol`) || body.includes(`Bot`) || body.includes(`ariel`) || body.includes(`P`) || body.includes(`p`) || body.includes(`bot`) || body.includes(`Bot`) || body.includes(`bot`)){
arielspkece.sendImageAsSticker(m.chat, manggil, farielsp2, { packname: `Aespi Botz Aktif`, author: `Ketik menu Jika Anda Tidak Muncul Tombol Silahkan Ketik menu2` })
}
//━━━━━━━━━━━━━━━[ PUBLIC & SELF ]━━━━━━━━━━━━━━━━━//
